    ...
    <nav className="w-full p-2 text-light-blue  pr-4 sticky top-12 bg-background-dark">
        ...
        <ul className='flex justify-between items-center text-xl font-semibold'>
            ...
            <li className="flex gap-8 items-center text-lg">
                ...
                <Link href={`/dashboard/c/${crm?.crmUuid}/schedule`} className={`${(/.+\/schedule.*/).test(pathName) && "text-black px-2 clippath bg-light-blue"} transition-colors hover:text-greenish `}><Text text={{swe: "Scheman", eng: "Schedule"}} /></Link>
                ...
                <Link href={`/dashboard/c/${crm?.crmUuid}/vehicles`} className={`${(/.+\/vehicles.*/).test(pathName) && "text-black px-2 clippath bg-light-blue"} transition-colors hover:text-greenish `}><Text text={{swe: "Fordon", eng: "Vehicles"}} /></Link>
                <Link href={`/dashboard/c/${crm?.crmUuid}/storage`} className={`${(/.+\/storage.*/).test(pathName) && "text-black px-2 clippath bg-light-blue"} transition-colors hover:text-greenish `}><Text text={{swe: "Lager", eng: "Storage"}} /></Link>
                <Link href={`/dashboard/c/${crm?.crmUuid}/files`} className={`${(/.+\/files.*/).test(pathName) && "text-black px-2 clippath bg-light-blue"} transition-colors hover:text-greenish `}><Text text={{swe: "Filer", eng: "Files"}} /></Link>
